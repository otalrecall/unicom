...
public class MultiRadarChartService {
     ...
     * @param labels
     */
    public void createChart(ChartViewer chartViewer, String[] labels) {
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        double screenSizeWidth = screenSize.getWidth();
        double screenSizeHeight = screenSize.getHeight();

        polarChart = new PolarChart((int) (screenSizeWidth/1.3), (int) (screenSizeHeight/1.6), Chart.goldColor(), 0x000000, 1);
        ...
        polarChart.setPlotArea((int) (screenSizeWidth/1.3)/2, (int) (screenSizeHeight/1.6)/2, (int) (screenSizeWidth/1.3/2/3),
                0xffffff);
        ...
        chartViewer.setImageMap(polarChart.getHTMLImageMap("clickable", "",
     ...
     * @param entryId
     */
    public void compareObjects(ChartViewer chartViewer, JScrollPane graphicAreaScrollPane, JLabel similarityLabel,
                               GraphData graphData, int entryId) {
        ...
        JTable graphicAreaTable = new JTable(graphicAreaTableData, graphicAreaTableColumnNames);
